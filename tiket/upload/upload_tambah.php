      ...
      <div class="table-data">
        <div class="order">
          ...
          <div class="konten">
            ...
            <div style="margin: 15px 35px 10px;"><i class="bi bi-shield-fill-exclamation"></i> Kode Mhs Dapat dilihat Di Halaman User "kode "</div>
            <div class="pesan-peringatan"><?php
                                          if (isset($_GET['pesan'])) {
                                            peringatan($_GET['pesan']);
                                          }
                                          ?></div>
            <div class="artikel">
              <form class="horizontal" action="upload_tambah_proses" method="POST" enctype="multipart/form-data">
                <fieldset>
                  <legend>Data File</legend>
                  <div class="grup">
                    <label for="id_mhs">Kode mhs<span class="required">*</span></label>
                    <input type="text" name="id_mhs" required placeholder="Masukkan id_mhs Anda">
                  </div>
                  <div class="grup">
                    <label for="Nama-File">Nama File<span class="required">*</span></label>
                    <input type="text" name="judul" required placeholder="Masukkan Nama File Anda">
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div class="grup">
                    ...
                    <textarea type="text" name="keterangan" required placeholder="Masukkan keterangan Anda"></textarea>
                  </div>
                  <div class="grup">
                  ...
                  <div class="grup">
                    ...
                    <input type="date" name="tanggal" pattern="Tanggal/Bulan/Tahun" required placeholder=" Masukkan Tanggal">
                  </div>
                  <div class="input-group input-group-md mb-3">
                    <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="file">
                  </div>
